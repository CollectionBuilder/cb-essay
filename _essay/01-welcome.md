...
More recently, we've worked with Grad Students through our [Center for Digital Inquiry and Learning](https://cdil.lib.uidaho.edu/) who wanted to flip our setup around so they could write essays with CollectionBuilder underneath.{% include essay/feature/aside.html text="See [Sedimentation](https://cdil.lib.uidaho.edu/sedimentation/), [Tender Spaces](https://cdil.lib.uidaho.edu/tender-spaces/), and [Fire Lines](https://cdil.lib.uidaho.edu/fire-lines/)" %} It's led to some great work, and we're excited to open the framework we've built from those projects up to more users. 
